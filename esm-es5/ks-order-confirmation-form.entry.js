...
var OrderForm = /** @class */ (function () {
    ...
    class_1.prototype.Submit = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var form, inputs, highestPosition, valid, i, input, inputTop;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        event.preventDefault();
                        form = this.root.querySelector("form");
                        inputs = form.querySelectorAll("ks-input-dynamic, ks-order-document-select, ks-input-text, ks-input-textarea, ks-input-check, ks-order-inpost, ks-order-pocztapunkt");
...
export { OrderForm as ks_order_confirmation_form };
