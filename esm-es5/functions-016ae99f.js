...
function OpenSuggestions(id, name) {
    var suggestions = document.createElement("ks-product-suggestions");
...
export { AddToCart as A, RemoveFromFavourites as R, AddToFavourites as a, RemoveAllFavourites as b };
