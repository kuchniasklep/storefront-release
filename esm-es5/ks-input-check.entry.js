...
var InputCheck = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        var type = this.radio ? "radio" :
            this.checkbox ? "checkbox" :
                "checkbox";
        var valid = this.valid ? "" : "uk-form-danger";
        return (h("div", { class: "uk-margin" }, h("label", { class: valid }, h("input", { class: "uk-margin-small-right uk-" + type, name: this.name, type: type, checked: this.currentCheck, value: this.value, onChange: function (event) {
                _this.currentCheck = event.target.checked;
                _this.Validate();
