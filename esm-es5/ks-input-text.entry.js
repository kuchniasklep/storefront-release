...
var InputText = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        var isValid = this.message == "";
        var type = this.email ? "email" :
            this.password ? "password" :
                "text";
        var valid = isValid ? "" : "uk-form-danger";
        var validText = isValid ? "" : "uk-text-danger";
        var center = this.center ? " uk-text-center" : "";
        var size = this.large ? " uk-form-large" : "";
        var emphasis = this.emphasis ? { borderColor: isValid ? "black" : "#e21334", backgroundColor: "white" } : null;
        return (h("div", { class: "uk-margin" }, this.label ?
            ...
            : null, h("input", { class: "uk-input " + valid + center + size, style: emphasis, name: this.name, type: type, placeholder: this.placeholder, value: this.value, onChange: function () { return _this.Change(); } }), this.message != "" ?
            h("p", { class: "uk-text-danger", style: { marginTop: "5px" } }, this.message)
            : null));
    };
    class_1.prototype.Change = function () {
        this.value = this.root.querySelector("input").value;
        if (!this.novalidate)
            this.Validate();
    };
    class_1.prototype.MessageWatcher = function () {
        this.render();
    };
    class_1.prototype.IsValid = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.message == "" ? true : false];
            });
        });
    };
    class_1.prototype.Validate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var input, message, regex, regex, regex, other, regex;
            return __generator(this, function (_a) {
                ...
                if (this.sameAs) {
                    other = this.root.closest("form").querySelector("input[name='" + this.sameAs + "']");
