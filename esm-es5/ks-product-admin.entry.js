    ...
    ProductAdmin.prototype.render = function () {
        ...
        return [
            h("div", { class: "bar" }, h("div", null, h("ks-icon", { name: "home" }), " ", this.homeQuantity), this.externalQuantity != "" ?
                ...
                h("button", { class: "button", onClick: function () { return _this.expanded = !_this.expanded; } }, h("ks-icon", { name: this.expanded ? "chevron-up" : "chevron-down" }))
                : null)),
            this.distributors ?
