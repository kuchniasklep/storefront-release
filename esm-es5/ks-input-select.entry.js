...
var InputSelect = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h("div", { class: "uk-margin" }, this.label ?
            ...
            : null, h("select", { class: "uk-select" + (this.error ? " uk-form-danger" : ""), style: lightUp, name: this.name, onChange: function () { return _this.Validate(); } }, h("slot", null))));
    };
