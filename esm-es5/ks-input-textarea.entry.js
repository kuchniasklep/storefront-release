...
var InputTextarea = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h("div", { class: "uk-margin" }, this.label ?
            ...
            : null, h("textarea", { rows: this.rows, class: "uk-textarea " + valid, name: this.name, placeholder: this.placeholder, onChange: function () { return _this.Validate(); } }), !this.valid ?
    ...
    class_1.prototype.Validate = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                input = this.root.querySelector("textarea");
                valid = true;
                message = "";
