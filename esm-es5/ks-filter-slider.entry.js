...
var FilterSlider = /** @class */ (function () {
    ...
    FilterSlider.prototype.componentDidLoad = function () {
        ...
        if (this.ids) {
            sliderInstance.noUiSlider.on("set", function () {
                var range = sliderInstance.noUiSlider.get();
                var from = _this.valueArray.findIndex(function (value) { return parseFloat(value) == parseFloat(range[0]); });
                var to = _this.valueArray.findIndex(function (value) { return parseFloat(value) == parseFloat(range[1]); });
                _this.fromId = _this.idArray[from];
                _this.toId = _this.idArray[to];
            });
        }
        var fromIndex = this.idArray.findIndex(function (id) { return parseInt(id) == _this.from; });
        var toIndex = this.idArray.findIndex(function (id) { return parseInt(id) == _this.to; });
        var from = this.from ? parseFloat(this.valueArray[fromIndex]) : null;
        var to = this.to ? parseFloat(this.valueArray[toIndex]) : null;
        sliderInstance.noUiSlider.set([from, to]);
    };
    FilterSlider.prototype.convertValuesToRangeMap = function (values) {
        var rangeMap = {};
    ...
    FilterSlider.prototype.render = function () {
        var disabled = !this.fromId || !this.toId;
        return [
            h("div", null),
            h("input", { type: "hidden", name: this.name, value: this.fromId + "," + this.toId, disabled: disabled })
        ];
    };
    Object.defineProperty(FilterSlider.prototype, "el", {
...
export { FilterSlider as ks_filter_slider };
