...
var FilterColor = /** @class */ (function () {
    function FilterColor(hostRef) {
    ...
    FilterColor.prototype.componentWillLoad = function () {
        var _this = this;
        var found = ColorList.filter(function (c) { return c.name.includes(_this.color); });
        if (found.length > 0) {
            this.hex = found[0].color;
            this.material = found[0].material;
        }
    };
    FilterColor.prototype.render = function () {
        return [
