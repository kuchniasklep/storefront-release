...
var ProductWide = /** @class */ (function () {
    function ProductWide(hostRef) {
        registerInstance(this, hostRef);
        this.unavailable = false;
        this.cartLoading = false;
        this.mobile = false;
    }
    ProductWide.prototype.componentDidLoad = function () {
        this.root.style.display = "block";
    };
    ProductWide.prototype.CartHandler = function (success) {
        if (!success)
            this.cartLoading = false;
    };
    ProductWide.prototype.resizeHandler = function () {
        if (window.innerWidth <= 700)
            this.mobile = true;
        else
            this.mobile = false;
    };
    ProductWide.prototype.componentWillLoad = function () {
        this.resizeHandler();
    };
    ProductWide.prototype.render = function () {
        var currentPrice;
    ...
    Object.defineProperty(ProductWide.prototype, "root", {
