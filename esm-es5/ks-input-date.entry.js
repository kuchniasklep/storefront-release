...
var InputDate = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h("div", { class: "uk-margin" }, this.label ?
            ...
            : null, h("input", { class: "uk-input " + valid, name: this.name, type: "text", placeholder: this.placeholder, onChange: function () { return _this.Validate(); } }), !this.valid ?
    ...
    class_1.prototype.componentDidLoad = function () {
        var dateElement = this.root.querySelector("input");
...
export { InputDate as ks_input_date };
