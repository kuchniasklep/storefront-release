...
var CartSelectPayment = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        var activeItem = this.payment.find(function (value) {
        ...
        return [
            ...
            h("div", { class: "items", hidden: !this.toggled }, this.payment.map(function (item) { return h("ks-cart-select-item", { key: item.id, logo: item.logo, name: item.name, price: item.price, color: item.color, onClick: function () { return _this.ActivateItem(item.id); } }); }))
        ];
    };
...
export { CartSelectPayment as ks_cart_select_payment };
