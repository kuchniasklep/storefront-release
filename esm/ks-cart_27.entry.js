import { h, r as registerInstance, g as getElement, c as createEvent, H as Host } from './index-74ff0cef.js';
...
const CartCountrySelect = class {
  ...
  render() {
    return [
      ...
      h("div", { class: "select" }, h("div", { class: "icons" }, h("span", { "uk-icon": "icon: world; ratio: 1.2;" }), h("span", { "uk-icon": "icon: triangle-down; ratio: 1.2;" })), h("select", { onChange: (ev) => this.onChangeHandler(ev) }, h("slot", null)))
    ];
  }
  get root() { return getElement(this); }
};
...
const CartDiscountCode = class {
  ...
  render() {
    return [
      h("form", { onSubmit: (e) => this.onDiscountSubmitHandler(e) }, h("ks-input-text", { emphasis: true, center: true, placeholder: this.placeholder, name: "discountCode" }), h("button", { type: "submit", class: "uk-button uk-button-secondary" }, this.loading ? h("div", { "uk-spinner": true }) : h("span", null, "Aktywuj"))),
...
const CartDiscountPoints = class {
  ...
  render() {
    return [
      h("form", { onSubmit: (e) => this.onDiscountSubmitHandler(e), novalidate: true }, h("ks-input-number", { emphasis: true, center: true, placeholder: this.placeholder, min: 1, max: this.points, step: 10, name: "pointCount" }), h("button", { type: "submit", class: "uk-button uk-button-secondary" }, this.loading ? h("div", { "uk-spinner": true }) : h("span", null, "Aktywuj"))),
