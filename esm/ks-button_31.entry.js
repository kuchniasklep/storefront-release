import { r as registerInstance, h, g as getElement, H as Host, c as createEvent } from './index-cc43f019.js';
import { c as createCommonjsModule, a as commonjsGlobal, g as getDefaultExportFromCjs } from './_commonjsHelpers-ba3f0406.js';
import { c as createStore, V as ValidateInput } from './validate-a41edad9.js';
...
const CookiePopup = class {
  ...
  render() {
    return h(Host, { hidden: this.hidden, hide: this.hide }, h("p", null, this.message), h("ks-button", { round: true, border: true, name: this.button, onClick: () => this.hidepanel() }));
  }
  get root() { return getElement(this); }
};
...
const Footer = class {
  ...
  render() {
    return [
      h("div", { class: "about" }, h("div", { class: "info" }, h("div", { class: "contact" }, h("ks-img", { sync: true, target: "body", class: "logo", src: this.logo }), h("a", { href: `mailto:${this.email}` }, " ", this.email, " "), h("a", { href: `tel:${this.phone}` }, " ", this.phone, " ")), h("div", { class: "reviews" }, h("slot", { name: "buttons" }))), h("div", { class: "links" }, h("slot", null))),
...
const imgCss = "ks-img{display:-webkit-box;display:-ms-flexbox;display:flex;position:relative;height:100%;width:100%;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}ks-img[limit]{height:unset;width:unset}ks-img img{max-width:initial;height:initial;-webkit-box-sizing:border-box;box-sizing:border-box;opacity:1;-webkit-transition:opacity 0.3s ease;transition:opacity 0.3s ease}ks-img canvas{max-width:100%;max-height:100%;-webkit-box-sizing:border-box;box-sizing:border-box}ks-img .horizontal{width:100%;height:auto}ks-img .vertical{width:auto;height:100%}ks-img .contained{max-width:100%;max-height:100%;width:auto;height:auto}ks-img[src*=\".svg\"] .contained{width:100%;height:100%}ks-img.left{-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start}ks-img.right{-webkit-box-pack:end;-ms-flex-pack:end;justify-content:flex-end}ks-img.center{-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}ks-img img.loading{opacity:0}ks-img[fill] img{position:absolute;max-width:100%;max-height:100%;width:auto;height:auto;top:0px;bottom:0px;left:0px;right:0px;margin:auto}";
...
const NavbarSearchMobile = class {
  ...
  render() {
    return (h("nav", null, h("form", { method: "post", action: "szukaj.html" }, h("a", { onClick: () => this.submit() }, h("ks-icon", { name: "search", size: 1.1 })), h("input", { "aria-label": "Szukaj produkt\u00F3w", name: "szukaj", type: "search" }), h("input", { type: "hidden", name: "postget", value: "tak" }), h("input", { type: "hidden", name: "opis", value: "nie" }), h("input", { type: "hidden", name: "nrkat", value: "tak" }), h("input", { type: "hidden", name: "kodprod", value: "tak" }))));
  }
  get root() { return getElement(this); }
};
...
const NavbarSidebar = class {
  ...
  render() {
    ...
    return h("ks-sidepanel", null, h("nav", null, h("button", { class: "close", onClick: () => this.toggle() }, h("ks-icon", { name: "x" })), h("ul", null, h("li", { class: "header" }, "MENU"), h("li", { class: "divider" }), loginLink ?
      ...
      : null, h("li", { class: "small" }, h("a", { href: cartLink }, "Koszyk", cartCount && cartCount != 0 ?
      h("span", { class: "badge" }, cartCount) :
      h("ks-icon", { name: "shopping-bag" }))), h("li", { class: "small" }, h("a", { href: favouritesLink }, "Schowek", favouritesCount && favouritesCount != 0 ?
      ...
      : null, h("li", { class: "header" }, "KATEGORIE"), h("li", { class: "divider" }), store.get("categories").map((category, index) => h("li", { class: category.children ? "parent" : "" }, h("a", { href: category.children ? "" : category.url, onClick: (e) => this.expand(e, index) }, category.name, category.children ?
      h("ks-icon", { name: (this.active == index) ? "minus" : "plus" })
      : null), category.children ?
      h("ul", { class: "children" + (this.active == index ? " active" : ""), style: this.childrenHeight(index, category) }, category.children.map(child => h("li", null, h("a", { href: child.url }, child.name))), h("li", null, h("a", { href: category.url, class: "seeall" }, "Zobacz wszystko")))
      : null)))));
  }
  get root() { return getElement(this); }
};
...
const NewsletterPopup = class {
  ...
  render() {
    return [
      h("ks-dialog", { nopadding: true, onClosed: () => this.SetCookie() }, h("form", { onSubmit: e => this.requestHandler(e) }, h("div", { class: "info" }, h("svg", { class: "top", viewBox: "0 0 303 15", width: 909, height: 45 }, h("text", { x: "0", y: "12" }, "Zapisz si\u0119 do naszego Newslettera i zyskaj")), h("svg", { class: "heading", viewBox: "0 0 96 12", width: 960, height: 130 }, h("text", { x: "-1", y: "12" }, "KUPON 10Z\u0141")), h("p", null, this.infoMessage)), !this.loggedIn ?
...
const TopBanner = class {
  ...
  render() {
    return [
      h("a", { href: this.shipping }, h("slot", null)),
      h("button", { class: "close", onClick: () => this.disable() }, h("ks-icon", { name: "x" }))
    ];
  }
  get root() { return getElement(this); }
};
