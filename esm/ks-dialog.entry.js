import { r as registerInstance, e as createEvent, h, g as getElement } from './index-a14dfead.js';
...
const dialog = class {
  ...
  render() {
    return h("ks-overlay", { dark: this.dark, close: this.close, onClosed: () => this.closeHandler() }, h("div", { class: "content" }, this.close ?
