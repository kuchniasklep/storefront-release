import { r as registerInstance, h, H as Host, g as getElement } from './index-46fe532f.js';
...
const Banner = class {
  ...
  render() {
    return h(Host, { class: "swiper-slide", style: { backgroundColor: this.color } }, h("a", { href: this.link }, h("canvas", { width: this.width, height: this.height }), h("ks-img", { vertical: true, sync: this.sync, src: this.image, alt: this.name, width: this.width, height: this.height })));
  }
};
...
const Featured = class {
  ...
  render() {
    return (h("a", { href: this.link, style: { backgroundColor: this.color } }, h("ks-img", { sync: true, src: this.image, alt: this.alt, width: this.width, height: this.height, target: "ks-featured" }), h("div", { class: "icon" }, h("ks-icon", { name: "link", size: 1.1 }))));
  }
};
