...
const CartEasyprotect = class {
  ...
  render() {
    ...
    return [
      h("div", { class: "top" }, h("div", { class: "content" }, h("slot", null)), h("ks-img2", { src: this.image, width: this.width, height: this.height })),
  ...
  insuredItem(id, [months, price]) {
    ...
    return h("div", { class: "item" }, h("div", { class: "name" }, " ", name, " "), h("div", { class: "option" }, " ", months, " miesi\u0119cy ", price, " z\u0142"), h("ks-icon", { name: "x" }));
  }
