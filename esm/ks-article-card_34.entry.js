  ...
  render() {
    ...
    return [
      h("nav", null, h("div", { class: "logo" }, h("div", null, h("a", { href: "/" }, h("ks-img", { contained: true, sync: true, src: this.logo, width: 217, height: 35, alt: "kuchniasklep.pl" })), this.promo ? this.promoLink && !this.mobile ?
        ...
        : null, h("ks-navbar-button", { name: "Menu", link: "#navbar-sidebar", toggle: true, icon: "menu", class: "mobile-tablet" })), h("ks-navbar-contact-panel", { phone: this.phone, email: this.email, contact: this.contact })),
      !this.mobile ?
