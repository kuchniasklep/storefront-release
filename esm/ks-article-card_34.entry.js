import { r as registerInstance, h, g as getElement, H as Host, c as createEvent } from './index-22b73bd9.js';
import { A as AddToCart, R as RemoveFromFavourites, a as AddToFavourites } from './functions-b10da890.js';
import { c as createCommonjsModule, a as commonjsGlobal, g as getDefaultExportFromCjs } from './_commonjsHelpers-84ca41fa.js';
import { c as createStore } from './index-fe9ed645.js';
...
const ButtonFav = class {
  ...
  render() {
    const padding = { padding: "5px" };
    return (h("button", { class: "uk-button uk-button-danger uk-button-danger-darker uk-position-relative uk-width-expand " + (this.padding ? "uk-padding-small@s" : ""), style: this.padding ? padding : null, "aria-label": "Do koszyka", onClick: () => { this.ClickHandler(); } }, this.loading ?
      h("div", { "uk-spinner": "ratio: 0.6" }) :
...
const NavbarCategorySimple = class {
  ...
  render() {
    ...
    return h(Host, { style: divstyle }, h("a", { href: this.category.url, style: linkstyle }, this.category.name, " ", haschildren ? h("ks-icon", { name: "chevron-down", size: 0.8 }) : null), haschildren ?
...
const NavbarCategoryView = class {
  ...
  render() {
    ...
    return h(Host, { style: divstyle }, h("a", { href: this.category.url, style: linkstyle }, this.category.name, haschildren ? h("ks-icon", { name: "chevron-down", size: 0.8 }) : null), haschildren ?
      h("div", { class: "children", style: childrenstyle }, h("div", { class: "buttons" }, this.category.children.map((child, index) => h("a", { href: child.url, class: this.active == index && child.children ? "active" : "", onMouseOver: () => this.SetActive(index, !!child.children) }, child.name, " ", !child.children ? h("ks-icon", { name: "link", size: 0.65 }) : null))), h("div", { class: "content", style: { maxHeight: this.CalculateHeight() + "px" } }, this.category.children.map((child, index) => h("div", { hidden: this.active != index || this.hidden }, child.children ? child.children.map((item) => h("a", { href: item.url }, item.name)) : null))), h("div", { class: "graphic", style: { maxHeight: this.CalculateHeight() + "px" } }, this.category.children.map((child, index) => child.image ?
...
const navbarCss = "ks-navbar{display:block;min-height:104px}ks-navbar>nav{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;position:relative;color:var(--navbar-text-color);background-color:var(--navbar-color)}ks-navbar>nav>a{max-width:217px;width:100%}ks-navbar .logo{margin:0px 30px 0px 15px;max-width:217px}#ks-navbar-menu-buttons{-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-sizing:border-box;box-sizing:border-box;min-height:70px;padding:0 15px;text-decoration:none}@media only screen and (max-width: 639px){ks-navbar .tablet-desktop{display:none}}@media only screen and (max-width: 959px){ks-navbar .desktop{display:none}}@media only screen and (min-width: 960px){ks-navbar .mobile-tablet{display:none}}";
...
const navbarButtonCss = "ks-navbar-button{display:block;position:relative;height:70px}ks-navbar-button>a{outline-style:none;text-decoration:none !important;color:var(--navbar-text-color) !important;-webkit-transition:var(--transition-background-color);transition:var(--transition-background-color)}ks-navbar-button>a:hover{background-color:var(--navbar-color-hover)}ks-navbar-button>a:active{background-color:var(--navbar-color-active)}ks-navbar-button>div{position:absolute;bottom:-28px;z-index:2147483649;width:250%;left:-75%;font-size:14px;text-transform:uppercase;text-align:center;color:var(--navbar-text-color);opacity:0;-webkit-transition:opacity 0.3s ease;transition:opacity 0.3s ease;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;pointer-events:none}ks-navbar-button>a:hover+div{opacity:1}ks-navbar-contact>div ks-navbar-button>div{display:none}@media only screen and (max-width: 1000px){ks-navbar-button>div{display:none}}ks-navbar-button .count{-webkit-box-sizing:border-box;box-sizing:border-box;min-width:30px;height:30px;padding:0px 0px;border-radius:500px;vertical-align:middle;background:var(--color-secondary);color:var(--navbar-text-color);font-size:16px;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}ks-navbar-button>a{display:-webkit-box !important;display:-ms-flexbox !important;display:flex !important;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;height:100%}ks-navbar-button ks-icon svg.medium{stroke-width:1.2}";
...
const NavbarButton = class {
  ...
  render() {
    ...
    return [
      h("a", { href: this.link, "uk-toggle": toggle, style: { lineHeight: "70px", minWidth: "60px" }, "aria-label": this.name }, h("ks-icon", { name: this.icon, size: 1.4 }), this.count && this.count != 0 ?
...
const NavbarCategories = class {
  ...
  render() {
    return h("nav", null, " ", store.get("categories").map(category => {
      let expanded = false;
...
const navbarContactPanelCss = "ks-navbar-contact-panel{display:none;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:end;-ms-flex-align:end;align-items:flex-end;position:absolute;top:0px;left:0px;overflow:hidden;width:100%;color:var(--navbar-category-text-color);z-index:100000}ks-navbar-contact-panel.visible{-webkit-animation:fade-in 0.3s ease 1;animation:fade-in 0.3s ease 1}ks-navbar-contact-panel.hidden{-webkit-animation:fade-out 0.3s ease 1;animation:fade-out 0.3s ease 1}ks-navbar-contact-panel[toggled]{display:-webkit-box;display:-ms-flexbox;display:flex}ks-navbar-contact-panel .navbar{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:reverse;-ms-flex-direction:row-reverse;flex-direction:row-reverse;position:relative;right:0px;height:70px;background-color:var(--navbar-color)}ks-navbar-contact-panel .content{display:-webkit-box;display:-ms-flexbox;display:flex;width:100%;background-color:var(--navbar-category-color);-webkit-box-shadow:0 6px 6px rgba(0, 0, 0, 0.2);box-shadow:0 6px 6px rgba(0, 0, 0, 0.2)}ks-navbar-contact-panel .map{-webkit-box-flex:0;-ms-flex:none;flex:none;background-color:#eeeeee}ks-navbar-contact-panel .info{display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-flex:1;-ms-flex:1;flex:1;padding:20px;font-size:16px;text-align:center}ks-navbar-contact-panel .address,ks-navbar-contact-panel .buttons{width:100%}ks-navbar-contact-panel .buttons a{-webkit-box-sizing:border-box;box-sizing:border-box;width:100%;margin:2px;padding:3px;font-size:18px;color:#ffffff;background-color:transparent;border:1px solid #ffffff;border-radius:500px}@media only screen and (max-width: 639px){ks-navbar-contact-panel .address{font-size:14px}ks-navbar-contact-panel .buttons a{font-size:14px}}@media only screen and (min-width: 640px){ks-navbar-contact-panel .margin{margin-right:10%}ks-navbar-contact-panel .address{width:calc(100% * 1 / 3.001)}ks-navbar-contact-panel .buttons{width:calc(100% * 2 / 3.001)}}@media only screen and (min-width: 1200px){ks-navbar-contact-panel .info>*{width:50%}}@media only screen and (max-width: 1200px){ks-navbar-contact-panel .content{-webkit-box-orient:vertical;-webkit-box-direction:reverse;-ms-flex-direction:column-reverse;flex-direction:column-reverse;height:calc(100vh - 72px)}}";
...
const NavbarContactPanel = class {
  ...
  render() {
    return h(Host, { class: this.visible }, h("div", { class: "navbar", style: { width: `${this.menuWidth}px` } }, h("ks-navbar-button", { icon: "x", onClick: () => this.Toggle() })), h("div", { class: "content" }, this.initialized ?
      ...
      : null, h("div", { class: "info ks-text-decorated" }, h("div", { class: "address", innerHTML: this.contact }), h("div", { class: "buttons" }, h("div", { class: "margin" }, h("a", { href: "tel:" + this.phone, class: "uk-button" }, this.phone), h("br", null), h("a", { href: "mailto:" + this.email, class: "uk-button" }, this.email))))));
  }
  get root() { return getElement(this); }
};
...
const NavbarSearch = class {
  ...
  render() {
    return (h("form", { method: "post", action: "szukaj.html" }, h("a", { onClick: () => this.submit() }, h("span", { "uk-icon": "icon: search; ratio: 1.3" })), h("input", { "aria-label": "Szukaj produkt\u00F3w", name: "szukaj", type: "search" }), h("input", { type: "hidden", name: "postget", value: "tak" }), h("input", { type: "hidden", name: "opis", value: "nie" }), h("input", { type: "hidden", name: "nrkat", value: "tak" }), h("input", { type: "hidden", name: "kodprod", value: "tak" })));
  }
  get root() { return getElement(this); }
};
NavbarSearch.style = navbarSearchCss;

const navbarSearchMobileCss = "ks-navbar-search-mobile{display:block}ks-navbar-search-mobile>nav{background-color:var(--navbar-category-color)}";
...
const NavbarSidebar = class {
  ...
  render() {
    ...
    const cartCount = store.get("cartCount");
    const favouritesCount = store.get("favouritesCount");
    return h("nav", null, h("div", { id: "navbar-sidebar", class: "uk-hidden@m", "uk-offcanvas": "flip: true; overlay: true", style: { zIndex: "2147483648" } }, h("div", { class: "uk-offcanvas-bar uk-width-expand uk-width-medium@s" }, h("button", { class: "uk-offcanvas-close", type: "button", "uk-close": true }), h("ul", { class: "uk-nav-default uk-nav-parent-icon", "uk-nav": true }, h("li", { class: "uk-nav-header uk-hidden@m" }, "Menu"), h("li", { class: "uk-nav-divider uk-hidden@m" }), loginLink ?
      h("li", null, h("a", { href: loginLink }, "Zaloguj si\u0119 ", h("ks-icon", { name: "log-in", class: "uk-float-right" })))
      : null, h("li", { class: "uk-hidden@s" }, h("a", { href: cartLink }, "Koszyk", cartCount && cartCount != 0 ?
      h("span", { class: "uk-badge uk-float-right", style: { transform: "translateX(4px)" } }, cartCount) :
      h("ks-icon", { name: "shopping-bag", class: "uk-float-right" }))), h("li", { class: "uk-hidden@s" }, h("a", { href: favouritesLink }, "Schowek", favouritesCount && favouritesCount != 0 ?
      h("span", { class: "uk-badge uk-float-right", style: { transform: "translateX(4px)" } }, favouritesCount) :
      h("ks-icon", { name: "star", class: "uk-float-right" }))), accountLink ?
      h("li", null, h("a", { href: accountLink }, "Panel Klienta", h("ks-icon", { name: "user", class: "uk-float-right" })))
      : null, logoutLink ?
      h("li", null, h("a", { href: logoutLink }, "Wyloguj si\u0119", h("ks-icon", { name: "log-out", class: "uk-float-right" })))
      : null, h("li", { class: "uk-nav-header uk-margin-top" }, "Kategorie"), h("li", { class: "uk-nav-divider" }), store.get("categories").map(category => h("li", { class: category.children ? "uk-parent" : "" }, h("a", { href: category.children ? "#" : category.url }, category.name), category.children ?
      h("ul", { class: "uk-nav-sub" }, category.children.map(child => h("li", null, h("a", { href: child.url }, child.name))))
      : null))))));
  }
};
