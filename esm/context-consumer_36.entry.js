...
const NavbarContact = class {
  ...
  render() {
    ...
    return [
      h("ks-navbar-button", { name: "Kontakt", link: "#ks-navbar-contact", "animated-toggle": true, icon: "phone", onClick: () => this.Toggle() }),
      h("div", { style: { zIndex: "2147483647" } }, h("div", { hidden: !this.active, style: menuStyle }, h("ks-navbar-button", { style: { float: "right", marginRight: "15px" }, link: "#ks-navbar-contact", "animated-toggle": true, name: "Kontakt close", icon: "x", onClick: () => this.Toggle() })), h("div", { id: "ks-navbar-contact", hidden: true, class: "uk-position-absolute uk-overflow-hidden uk-light", style: contactStyle }, h("div", { class: "uk-flex uk-flex-wrap uk-width-1-1 " + (this.mobile == 0 ? "" : "uk-flex-column-reverse"), style: contactContainerStyle }, this.initialized ?
