...
const Filter = class {
  ...
  render() {
    return [
      h("div", { onClick: () => this.active = !this.active }, this.name, h("ks-icon", { name: this.active ? "minus" : "plus", size: 0.9 })),
      h("div", { class: "filter-content" }, h("slot", null))
    ];
  }
};
Filter.style = filterCss;

const filterCheckboxCss = "ks-filter-checkbox{display:block;margin-bottom:8px;line-height:20px}ks-filter-checkbox label{display:block;position:relative;padding-left:35px;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}ks-filter-checkbox input{position:absolute;cursor:pointer;opacity:0;height:0;width:0}ks-filter-checkbox .checkmark{position:absolute;top:0;left:0;height:20px;width:20px;background-color:#eee}ks-filter-checkbox .checkmark:after{content:\"✓\";position:absolute;display:block;left:4px;color:white;opacity:0}ks-filter-checkbox input:checked~.checkmark{background-color:#252525}ks-filter-checkbox input:checked~.checkmark:after{opacity:1}";
...
const filterColorCss = "ks-filter-color{display:block;margin-bottom:8px;line-height:20px}ks-filter-color label{display:block;position:relative;padding-left:27px;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}ks-filter-color input{position:absolute;cursor:pointer;opacity:0;height:0;width:0}ks-filter-color .checkmark{position:absolute;top:2px;left:0;height:20px;width:20px;background-color:#eee}ks-filter-color .checkmark:after{content:\"✓\";position:absolute;display:block;left:4px;color:white;opacity:0}ks-filter-color input:checked~.checkmark{background-color:#252525}ks-filter-color input:checked~.checkmark:after{opacity:1}ks-filter-color svg{margin-right:8px}";
...
const FilterColor = class {
  constructor(hostRef) {
    ...
    this.metal = [
      ...
      h("g", { transform: "matrix(1.25,0,0,1.25,-6,-36)" }, h("g", { transform: "matrix(1,0,0,1,0,24)" }, h("path", { d: "M21,21L5,21L21,5L21,21Z", style: { fill: "url(#Linear1)" } })))
    ];
    this.wood = [
...
const Pagination = class {
  ...
  render() {
    ...
    return [
      this.current > 1 ?
        h("a", { href: this.link(this.current - 1) }, h("ks-icon", { name: "chevron-left", size: 0.9 }))
        : null,
      pages.map(page => {
...
export { Filter as ks_filter, FilterCheckbox as ks_filter_checkbox, FilterColor as ks_filter_color, FilterSlider as ks_filter_slider, Filtering as ks_filtering, ListingHeader as ks_listing_header, ListingNavigation as ks_listing_navigation, Pagination as ks_pagination, Sorting as ks_sorting };
