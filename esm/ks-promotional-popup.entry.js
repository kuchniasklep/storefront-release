...
let PromotionalPopup = class {
  ...
  render() {
    ...
    return [
      h("ks-dialog", { smallmobile: true, dark: true, nopadding: true, onClosed: () => this.SetCookie() }, h("a", { href: this.href, class: "info", style: bgstyle }, h("div", { class: "texture", style: texturestyle }), h("ks-img2", { src: this.image })))
    ];
  }
