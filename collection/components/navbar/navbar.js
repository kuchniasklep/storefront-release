            ...
            h("nav", null,
                ...
                h("div", { id: "ks-navbar-menu-buttons" },
                    ...
                    this.accountLink ?
                        ...
                        : null,
                    h("ks-navbar-button", { name: "Schowek", link: this.heartLink, icon: "heart", count: favouritesCount, class: "tablet-desktop" }),
                    h("ks-navbar-button", { name: "Koszyk", link: this.cartLink, icon: "cart", count: cartCount, class: "tablet-desktop" }),
                    this.loginLink ?
