...
export class ProductNegotiate {
    ...
    render() {
        ...
        return [
            h("a", { id: "ks-negotiate-content", href: "#ks-negotiate-modal", "uk-toggle": true },
                h("slot", null)),
            h("div", { id: "ks-negotiate-modal", class: "uk-flex-top", "uk-modal": "bg-close: false; esc-close; false;" },
                h("div", { class: "uk-modal-dialog uk-modal-body uk-margin-auto-vertical" },
                    closeVisibility ?
