...
const Button = class {
  ...
  render() {
    ...
    return index.h("button", { disabled: this.disabled }, this.icon && this.left ? index.h("ks-icon", { name: this.icon, size: 0.9 }) : null, this.name, this.icon && !this.left ? index.h("ks-icon", { name: this.icon, size: 0.9 }) : null);
  }
...
const NavbarSearch = class {
  ...
  render() {
    var _a;
    return (index.h("form", { method: "post", action: "szukaj.html", onSubmit: e => this.submit(e) }, index.h("a", { onClick: e => this.submit(e) }, index.h("ks-icon", { name: "search", size: 1.1 })), index.h("input", { "aria-label": "Szukaj produkt\u00F3w", name: "szukaj", type: "search", autocomplete: "off", onFocus: () => this.focus(), onBlur: () => this.blur(), onInput: () => this.input(), onKeyDown: e => this.key(e) }), index.h("input", { type: "hidden", name: "postget", value: "tak" }), index.h("input", { type: "hidden", name: "opis", value: "nie" }), index.h("input", { type: "hidden", name: "nrkat", value: "tak" }), index.h("input", { type: "hidden", name: "kodprod", value: "tak" }), this.active && this.items && this.items.length > 0 ?
      index.h("div", { class: "list" }, (_a = this.items) === null || _a === void 0 ? void 0 : _a.map((item, index$1) => index.h("a", { href: item.url, class: index$1 == this.select ? "active" : "" }, item.name, index.h("ks-icon", { name: item.type == "category" ? "layers" : "bookmark", size: 0.9 }))))
      : null));
  }
  get root() { return index.getElement(this); }
};
