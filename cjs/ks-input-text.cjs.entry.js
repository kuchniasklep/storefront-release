...
const InputText = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "uk-margin" }, this.label ?
            ...
            : null, index.h("input", { class: "uk-input " + valid + center + size, style: emphasis, name: this.name, type: type, placeholder: this.placeholder, value: this.value, onChange: () => this.Change() }), this.message != "" ?
            index.h("p", { class: "uk-text-danger", style: { marginTop: "5px" } }, this.message)
            : null));
    }
    Change() {
