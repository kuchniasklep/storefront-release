  ...
  render() {
    ...
    return [
      index.h("nav", null, index.h("div", { class: "logo" }, index.h("div", null, index.h("a", { href: "/" }, index.h("ks-img", { contained: true, sync: true, src: this.logo, width: 217, height: 35, alt: "kuchniasklep.pl" })), this.promo ? this.promoLink && !this.mobile ?
        ...
        : null, index.h("ks-navbar-button", { name: "Menu", link: "#navbar-sidebar", toggle: true, icon: "menu", class: "mobile-tablet" })), index.h("ks-navbar-contact-panel", { phone: this.phone, email: this.email, contact: this.contact })),
      !this.mobile ?
