...
const index$1 = require('./index-7cc854df.js');
...
const NavbarButton = class {
  ...
  render() {
    ...
    return [
      index.h("a", { href: this.link, "uk-toggle": toggle, style: { lineHeight: "70px", minWidth: "60px" }, "aria-label": this.name }, index.h("ks-icon", { name: this.icon, size: 1.4 }), this.count && this.count != 0 ?
...
const NavbarContactPanel = class {
  ...
  render() {
    return index.h(index.Host, { class: this.visible }, index.h("div", { class: "navbar", style: { width: `${this.menuWidth}px` } }, index.h("ks-navbar-button", { icon: "x", onClick: () => this.Toggle() })), index.h("div", { class: "content" }, this.initialized ?
      ...
      : null, index.h("div", { class: "info ks-text-decorated" }, index.h("div", { class: "address", innerHTML: this.contact }), index.h("div", { class: "buttons" }, index.h("div", { class: "margin" }, index.h("a", { href: "tel:" + this.phone, class: "uk-button" }, this.phone), index.h("br", null), index.h("a", { href: "mailto:" + this.email, class: "uk-button" }, this.email))))));
  }
  get root() { return index.getElement(this); }
};
...
const NavbarSidebar = class {
  ...
  render() {
    ...
    const cartCount = store.get("cartCount");
    const favouritesCount = store.get("favouritesCount");
    return index.h("nav", null, index.h("div", { id: "navbar-sidebar", class: "uk-hidden@m", "uk-offcanvas": "flip: true; overlay: true", style: { zIndex: "2147483648" } }, index.h("div", { class: "uk-offcanvas-bar uk-width-expand uk-width-medium@s" }, index.h("button", { class: "uk-offcanvas-close", type: "button", "uk-close": true }), index.h("ul", { class: "uk-nav-default uk-nav-parent-icon", "uk-nav": true }, index.h("li", { class: "uk-nav-header uk-hidden@m" }, "Menu"), index.h("li", { class: "uk-nav-divider uk-hidden@m" }), loginLink ?
      index.h("li", null, index.h("a", { href: loginLink }, "Zaloguj si\u0119 ", index.h("ks-icon", { name: "log-in", class: "uk-float-right" })))
      : null, index.h("li", { class: "uk-hidden@s" }, index.h("a", { href: cartLink }, "Koszyk", cartCount && cartCount != 0 ?
      index.h("span", { class: "uk-badge uk-float-right", style: { transform: "translateX(4px)" } }, cartCount) :
      index.h("ks-icon", { name: "shopping-bag", class: "uk-float-right" }))), index.h("li", { class: "uk-hidden@s" }, index.h("a", { href: favouritesLink }, "Schowek", favouritesCount && favouritesCount != 0 ?
      index.h("span", { class: "uk-badge uk-float-right", style: { transform: "translateX(4px)" } }, favouritesCount) :
      index.h("ks-icon", { name: "star", class: "uk-float-right" }))), accountLink ?
      index.h("li", null, index.h("a", { href: accountLink }, "Panel Klienta", index.h("ks-icon", { name: "user", class: "uk-float-right" })))
      : null, logoutLink ?
      index.h("li", null, index.h("a", { href: logoutLink }, "Wyloguj si\u0119", index.h("ks-icon", { name: "log-out", class: "uk-float-right" })))
      : null, index.h("li", { class: "uk-nav-header uk-margin-top" }, "Kategorie"), index.h("li", { class: "uk-nav-divider" }), store.get("categories").map(category => index.h("li", { class: category.children ? "uk-parent" : "" }, index.h("a", { href: category.children ? "#" : category.url }, category.name), category.children ?
