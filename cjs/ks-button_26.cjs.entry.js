...
const index$1 = require('./index-f00963f7.js');
...
const CookiePopup = class {
  ...
  render() {
    return index.h(index.Host, { hidden: this.hidden, hide: this.hide }, index.h("p", null, this.message), index.h("ks-button", { round: true, border: true, name: this.button, onClick: () => this.hidepanel() }));
  }
  get root() { return index.getElement(this); }
};
...
const FooterButton = class {
  ...
  render() {
    return (index.h("a", { href: this.href, rel: "nofollow" }, index.h("ks-img", { src: this.image, observerMargin: "500px", width: this.width, height: this.height })));
  }
};
...
const NewsletterPopup = class {
  ...
  render() {
    return [
      index.h("ks-dialog", { nopadding: true, onClosed: () => this.SetCookie() }, index.h("form", { onSubmit: e => this.requestHandler(e) }, index.h("div", { class: "info" }, index.h("svg", { class: "top", viewBox: "0 0 303 15", width: 909, height: 45 }, index.h("text", { x: "0", y: "12" }, "Zapisz si\u0119 do naszego Newslettera i zyskaj")), index.h("svg", { class: "heading", viewBox: "0 0 96 12", width: 960, height: 130 }, index.h("text", { x: "-1", y: "12" }, "KUPON 10Z\u0141")), index.h("p", null, this.infoMessage)), !this.loggedIn ?
