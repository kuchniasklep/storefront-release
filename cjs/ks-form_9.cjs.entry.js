  ...
  render() {
    ...
    return [
      index.h("label", null, index.h("input", { name: this.name, type: type, checked: this.currentCheck, value: this.value, onChange: (event) => {
        ...
        index.h("ks-icon", { name: "check", size: 0.64 })
        : null, index.h("span", { innerHTML: this.label })),
...
const InputDynamic = class {
  ...
  render() {
    return (index.h("div", { class: "uk-position-relative" }, index.h("slot", null), this.loading ?
      index.h("div", { class: "uk-position-absolute uk-animation-fade", style: { top: "7px", right: "7px", animationDuration: "0.3s", animationDelay: "0.5s" }, "uk-spinner": "ratio: 0.9" })
      : null));
  }
  get root() { return index.getElement(this); }
};
...
const InputNumber = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "uk-margin" }, this.label ?
      index.h("label", { class: "uk-form-label " + validText, style: { marginBottom: "3px", display: "block" } }, this.label)
      : null, index.h("input", { class: "uk-input " + valid + center, style: emphasis, name: this.name, type: "number", step: this.step, placeholder: this.placeholder, onInput: this.InputHandler, onChange: this.ChangeHandler, onBlur: this.ChangeHandler }), !this.valid ?
      index.h("p", { class: "uk-text-danger", style: { marginTop: "5px" } }, this.validMessage)
      : null));
  }
  async IsValid() {
...
exports.ks_input_dynamic = InputDynamic;
exports.ks_input_number = InputNumber;
