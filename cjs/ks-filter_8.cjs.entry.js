...
const FilterColor = class {
  constructor(hostRef) {
    ...
    this.metal = [
      ...
      index.h("g", { transform: "matrix(1,0,0,1,-5,-29)" }, index.h("g", { transform: "matrix(1,0,0,1,0,24)" }, index.h("path", { d: "M21,21L5,21L21,5L21,21Z", style: { fill: "url(#Linear1)" } })))
    ];
    this.wood = [
