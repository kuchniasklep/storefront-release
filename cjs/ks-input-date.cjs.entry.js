...
var flatpickr = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const InputDate = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "uk-margin" }, this.label ?
            ...
            : null, index.h("input", { class: "uk-input " + valid, name: this.name, type: "text", placeholder: this.placeholder, onChange: () => this.Validate() }), !this.valid ?
...
exports.ks_input_date = InputDate;
